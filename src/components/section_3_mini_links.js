...
function Mini() {
  return (
    <div className="my-4 lg:my-20 lg:mx-48">
      {/* This section has 2 main parts, the outer and the inner layer */}
      <div className="mini_title text-center text-xl lg:text-3xl mb-8">We’re known for:</div>

      {/* This handles the 3 main links */}
      {/* Leadership button */}
      <div className="lg:flex content-center flex-wrap lg:ml-20">
        <div className="lg:w-1/3 ml-12 lg:ml-0 flex flex-row ">
          <svg className="w-10 lg:w-48 " xmlns="http://www.w3.org/2000/svg" width="84.97" height="57.074" viewBox="0 0 84.97 57.074">
          ...
          <button className="mini_button flex flex-row font-normal px-3 mt-3 w-64 lg:text-left text-xs md:text-base">
            <p>
        ...
        {/* Tech& Dev button */}
        <div className="lg:w-1/3 ml-12 lg:ml-0  flex flex-row ">
          <svg className="w-10 lg:w-48 " xmlns="http://www.w3.org/2000/svg" width="60.541" height="53.584" viewBox="0 0 60.541 53.584">
          ...
          <button className="mini_button flex flex-row font-normal px-3 mt-3 w-64 text-left text-xs md:text-base">
            <p>
        ...
        {/* Compliance button */}
        <div className="lg:w-1/3 ml-12 lg:ml-0 flex flex-row ">
          <svg className="w-10 lg:w-48 " xmlns="http://www.w3.org/2000/svg" width="46.873" height="62.246" viewBox="0 0 46.873 62.246">
          ...
          <button className="mini_button flex flex-row font-normal lg:py-2 px-3 mt-3 w-64 text-left text-xs md:text-base">
